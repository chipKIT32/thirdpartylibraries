...
#include	<string.h>
	...
	#define	GetFontDefinitionString(fontString, tableName, index)	strcpy_P(fontString, (char*)pgm_read_word(&(tableName[index])));
#else
	#define PGM_P  const char *
	#define	GetFontDefinitionString(fontString, tableName, index)	strcpy(fontString, tableName[index])
#endif
...
//	#define	PGM_P	void *
	...
	#define	READ_PTR_FROM_PGM	pgm_read_dword_far
#else
	#define	READ_PTR_FROM_PGM	pgm_read_word_near
#endif
