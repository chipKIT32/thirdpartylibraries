...
// you can swap around the elements below if your display is reversed
	...
	//*	had to change the name of this because of conflicts with the other library
#if (DISPLAY_WIDTH / CHIP_WIDTH  == 2) 
   byte gChipSelect[] = {1,2};        // this is for 128 pixel displays
#elif (DISPLAY_WIDTH / CHIP_WIDTH  == 3)
	//byte chipSelect[] = {0, 1, 2};  // this is for 192 pixel displays
   byte gChipSelect[] = {0, 2, 1};  // this is for 192 pixel displays on sanguino only
#endif
