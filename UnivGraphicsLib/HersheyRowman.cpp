...
//*******************************************************************************
	...
	{
		strcpy_P(fontDefString, (char*)READ_PTR_FROM_PGM(&(gHershyRowmanSimplexFontTable[tableIndex])));
	}
#endif
	...
	{
		strcpy_P(fontDefString, (char*)READ_PTR_FROM_PGM(&(gHershyRowmanDuplexFontTable[tableIndex])));
	}
#endif
	...
	{
		strcpy_P(fontDefString, (char*)READ_PTR_FROM_PGM(&(gHershyRowmanTriplexFontTable[tableIndex])));
	}
#endif
