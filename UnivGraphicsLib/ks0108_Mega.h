/*
  ...
  This is the configuration file for mapping Arduino Mega (ATmega1280 and ATmega2560) pins to the ks0108 Graphics LCD library
 ...
 */
#if 0
//#warning CSEL1/CSEL2 reversed
	#define CSEL1				34		// CS1 Bit   // swap pin assignments with CSEL2 if left/right image is reversed
	#define CSEL2				33		// CS2 Bit
#else
//#warning CSEL1/CSEL2 normal
