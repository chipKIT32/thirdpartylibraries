...
//*******************************************************************************
	...
	//	strcpy_P(fontDefString, (char*)pgm_read_word(&(gHershyTimesGreekFontTable[tableIndex])));
		GetFontDefinitionString(fontDefString, gHershyTimesGreekFontTable, tableIndex);
	}
#endif
	...
	//	strcpy_P(fontDefString, (char*)pgm_read_word(&(gHershyTimesItalicFontTable[tableIndex])));
		GetFontDefinitionString(fontDefString, gHershyTimesItalicFontTable, tableIndex);
	}
#endif
	...
	//	strcpy_P(fontDefString, (char*)pgm_read_word(&(gHershyTimesItalicBoldFontTable[tableIndex])));
		GetFontDefinitionString(fontDefString, gHershyTimesItalicBoldFontTable, tableIndex);
	}
#endif
	...
	//	strcpy_P(fontDefString, (char*)pgm_read_word(&(gHershyTimesRomanFontTable[tableIndex])));
		GetFontDefinitionString(fontDefString, gHershyTimesRomanFontTable, tableIndex);
	}
#endif
	...
	//	strcpy_P(fontDefString, (char*)pgm_read_word(&(gHershyTimesRomanBoldFontTable[tableIndex])));
		GetFontDefinitionString(fontDefString, gHershyTimesRomanBoldFontTable, tableIndex);
	}
#endif
